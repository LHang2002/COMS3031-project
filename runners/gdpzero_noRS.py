...
from core.players_kst import (
	ServerModel, ClientModel, KstSystemPlanner,
...
def main(cmd_args):
	...
	if cmd_args.llm == 'code-davinci-002':
		...
		UsrModel = ClientChatModel
		SysPlanner = KstChatSystemPlanner
	elif cmd_args.llm in [' Baichuan2-7B-Chat']:
		backbone_model = OpenAIChatModel(cmd_args.llm, cmd_args.gen_sentences)
		SysModel = ServerChatModel
		UsrModel = ClientChatModel
		SysPlanner = KstChatSystemPlanner
...
if __name__ == "__main__":
	...
	parser.add_argument('--llm', type=str, default="code-davinci-002", choices=["code-davinci-002", "gpt-3.5-turbo", "chatgpt","Baichuan2-7B-Chat"], help='OpenAI model name')
