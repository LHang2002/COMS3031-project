...
from core.evaluator_kst import KstEvaluator
from core.gen_models_kst import OpenAIModel, OpenAIChatModel, AzureOpenAIModel, AzureOpenAIChatModel
...
def main(args):
	...
	if args.judge in ['gpt-4','gpt-3.5-turbo']:
	...
	evaluator = KstEvaluator(backbone_model)
...
if __name__ == "__main__":
	...
	parser.add_argument('-f', type=str, help='path to the data file for comparing against human in Kst. See KstEvaluator documentation to see the format of the file.')
	parser.add_argument('--judge', type=str, default='gpt-4', help='which judge to use.', choices=['gpt-4','gpt-3.5-turbo','chatgpt'])
	parser.add_argument('--h2h', type=str, default='', help='path to the data file for head to head comparison. If empty compare against human in Kst.')
